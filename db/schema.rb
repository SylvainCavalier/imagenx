...
ActiveRecord::Schema[8.0].define(version: 2026_08_07_124630) do
  ...
  create_table "generation_batches", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "style_options", default: {}, null: false
    t.string "coherence_mode", default: "none", null: false
    t.index ["user_id"], name: "index_generation_batches_on_user_id"
  end

  create_table "generation_items", force: :cascade do |t|
    t.bigint "generation_batch_id", null: false
    t.text "prompt"
    t.integer "position"
    t.string "status", default: "pending", null: false
    t.string "image_url"
    ...
    t.index ["generation_batch_id"], name: "index_generation_items_on_generation_batch_id"
  end
  ...
  create_table "image_folders", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_image_folders_on_user_id"
  end
  ...
  create_table "prompt_presets", force: :cascade do |t|
    ...
    t.jsonb "style_options", default: {}, null: false
    t.string "coherence_mode", default: "none", null: false
    t.index ["user_id"], name: "index_prompt_presets_on_user_id"
  end

  create_table "saved_images", force: :cascade do |t|
    t.bigint "image_folder_id", null: false
    t.text "prompt"
    t.string "source_url"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
